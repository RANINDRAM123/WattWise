        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-gray-800/50 backdrop-blur-lg rounded-2xl p-8 hover:bg-yellow-500/10 transition-all duration-300">
            ...
            <div className="space-y-4">
              {[
                { time: "Morning Peak: 7-9 AM", load: "High", alert: "Reduce heavy appliance usage" },
                { time: "Afternoon: 2-4 PM", load: "Medium", alert: "Solar power optimal" },
                { time: "Evening Peak: 6-8 PM", load: "Very High", alert: "Critical savings period" }
              ].map((period, index) => (
